    ...
    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
      <DarkModeButton />
              ...
              <nav className="body-font md:m-auto flex flex-wrap items-center text-base justify-center">  
                <NavLink exact to="/" activeClassName="active" className="focus:outline-none mr-16 lg:p-4 py-3 px-0 border-transparent border-b-2 hover:border-orange-400">Work</NavLink>
                <NavLink exact to="/about" activeClassName="active" className="focus:outline-none lg:p-4 py-3 border-transparent border-b-2 hover:border-orange-400">About</NavLink>
              </nav>
            </div>
</header>
